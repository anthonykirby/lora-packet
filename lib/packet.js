...
function LoraPacket(packetContents) {
    ...
    this.toJSON = function() {
        ...
        if (that.isJoinRequestMessage()) {
            ...
            json.PHYPayload = {}
            json.PHYPayload.full = (p.PHYPayload);
            json.PHYPayload.MHDR = (p.MHDR);
            json.PHYPayload.MACPayload = (p.MACPayload);
            json.PHYPayload.MIC = (p.MIC);

            json.MACPayload = {};
            json.MACPayload.AppEUI = (p.AppEUI);
            json.MACPayload.DevEUI = (p.DevEUI);
            json.MACPayload.DevNonce = (p.DevNonce);
        } else if (that.isJoinAcceptMessage()) {
            ...
            json.MACPayload = {}
            json.MACPayload.AppNonce = (p.AppNonce);
            json.MACPayload.NetID = (p.NetID);
            json.MACPayload.DevAddr = (p.DevAddr);
            json.MACPayload.DLSettings = (p.DLSettings);
            json.MACPayload.RxDelay = (p.RxDelay);
            json.MACPayload.CFList = (p.CFList);
            ...
            json.MACPayload = {}
            json.MACPayload.FHDR = (p.FHDR);
            json.MACPayload.FPort = (that.getFPort());
            json.MACPayload.FRMPayload = (p.FRMPayload);

            json.FHDR = {}

            json.FHDR.DevAddr = p.DevAddr;
            json.FHDR.FCtrl = p.FCtrl;
            json.FHDR.FCnt = p.FCnt;
            json.FHDR.FOpts = p.FOpts;
